# Self-hosted AI starter kit (by the n8n team), modified by Felix
...
This is Felixs version with a couple of improvements and the addition of Open WebUI and Flowise(Original added by Coleam00
...
Download the N8N + OpenWebUI integration [directly on the Open WebUI site.](https://openwebui.com/f/coleam/n8n_pipe/) (more instructions below)
...
✅ [**Elasticsearch**](https://www.elastic.co/de/elasticsearch) - DokumentStore / VektoreStore

✅ [**Kibana**](https://www.elastic.co/de/kibana) - Dashboard for Elasticsearch
